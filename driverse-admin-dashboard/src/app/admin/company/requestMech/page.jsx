...
export default function AdminCompanyRequestMech() {
  ...
  const fetchRequests = async () => {
    try {
      ...
      const response = await fetch(`/api/CompanyRequestMech?${queryParams}`);
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-6 max-w-2xl w-full m-4 max-h-[90vh] overflow-y-auto">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold">Mechanic Request Details</h2>
  ...
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-800">Mechanic Requests</h1>
        <p className="text-gray-600">Manage and monitor mechanic service requests</p>
      </div>
